...
path_output='/home/climatedata/eurocordex2-full/indices_etccdi/CDD_seasonal';
...
do
	...
	for year in $(seq $first_year $last_year)
		...
		cdo eca_cdd $path_output/DJF_${year}* $path_output/CDD_DJF_${year}.nc
		cdo eca_cdd $path_output/MAM_${year}* $path_output/CDD_MAM_${year}.nc
		cdo eca_cdd $path_output/JJA_${year}* $path_output/CDD_JJA_${year}.nc
		cdo eca_cdd $path_output/SON_${year}* $path_output/CDD_SON_${year}.nc
	...
	cdo mergetime $path_output/CDD_DJF_* $path_output/CDD_MAM* $path_output/CDD_JJA* $path_output/CDD_SON* $path_output/${filename}
