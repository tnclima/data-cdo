...
fs::file_copy("/home/climatedata/obs/orography/MESAN_GAR_orography.nc",
              "/home/climatedata/obs/orography/MESAN_GAR_orography_vertices.nc", 
              overwrite = T)

nc_mesan <- nc_open("/home/climatedata/obs/orography/MESAN_GAR_orography_vertices.nc", write = T)
